...
C_U1tU1 := PBblas.PB_dgemm(TRUE, FALSE, 1.0, map_8x8_1, C_U1, map_8x8_1, C_U1,map_8x8_1);
test_c1 := Tests.DiffReport.Compare_Parts('Cholesky U1tU1', a1, C_U1tU1);

C_L1U1  := PBblas.PB_dgemm(FALSE, FALSE,1.0, map_8x8_1, C_L1, map_8x8_1, C_U1, map_8x8_1);
test_c2 := Tests.DiffReport.Compare_Parts('Cholesky L1U1', a1, C_L1U1);

C_L1L1t := PBblas.PB_dgemm(FALSE, TRUE, 1.0, map_8x8_1, C_L1, map_8x8_1, C_L1, map_8x8_1);
test_c3 := Tests.DiffReport.Compare_Parts('Cholesky L1L1t', a1, C_l1L1t);

// Multiple partition Cholesky
C_U9tU9 := PBblas.PB_dgemm(TRUE, FALSE, 1.0, map_8x8_9, C_U9, map_8x8_9, C_U9, map_8x8_9);
test_c4 := Tests.DiffReport.Compare_Parts('Cholesky U9tU9', a1, C_U9tU9);

C_L9U9  := PBblas.PB_dgemm(FALSE, FALSE, 1.0, map_8x8_9, C_L9, map_8x8_9, C_U9, map_8x8_9);
test_c5 := Tests.DiffReport.Compare_Parts('Cholesky L9U9', a1, C_L9U9);

C_L9L9t := PBblas.PB_dgemm(FALSE, TRUE, 1.0, map_8x8_9, C_L9, map_8x8_9, C_L9, map_8x8_9);
...
T_L1U1 := PBblas.PB_dgemm(FALSE, FALSE, 1.0, map_8x8_1, T_L1, map_8x8_1, T_U1, map_8x8_1);
...
T_L9U9 := PBblas.PB_dgemm(FALSE, FALSE,1.0, map_8x8_9, T_L9, map_8x8_9, T_U9, map_8x8_9);
test_t2 := Tests.DiffReport.Compare_Parts('LU L9U9', b1, T_L9U9);

// report results
rslt := test_c1 + test_c2 + test_c3 + test_c4 + test_c5 + test_c6 + test_t1 + test_t2;
EXPORT Factor := rslt;
