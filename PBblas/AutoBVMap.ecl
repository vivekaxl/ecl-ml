...
EXPORT AutoBVMap(dimension_t m_rows, dimension_t m_cols, dimension_t f_b_rows=0, dimension_t f_b_cols=0, UNSIGNED maxrows=5000, UNSIGNED maxcols=2500) := MODULE(PBblas.IMatrix_Map)
