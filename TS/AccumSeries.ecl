...
EXPORT AccumSeries(DATASET(Types.ModelObs) obs, DATASET(Types.Ident_Spec) degree_spec) := FUNCTION
    ...
    marked := JOIN(obs, degreeOK, LEFT.model_id=RIGHT.model_id, markDegree(LEFT, RIGHT), LOOKUP);
