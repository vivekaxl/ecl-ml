...
IMPORT TS;
EXPORT DATASET(TS.Types.ModelObs) Forecast(DATASET(TS.Types.UniObservation) obs, DATASET(TS.Types.Model_Parameters) parms, UNSIGNED2 forecast_periods) := FUNCTION
