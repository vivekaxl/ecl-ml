...
d3 := dataset([{1,1,100},{2,1,200},{3,1,300},{4,1,400}, {5,1,500},{6,1,600},{7,1,700},{8,1,800}, {9,1,900}, {10,1,1000}], ML.Types.NumericField );
d4 := dataset([{1,1,1},{2,1,10},{3,1,100},{4,1,1000}, {5,1,10000},{6,1,100000},{7,1,1000000},{8,1,10000000}, {9,1,100000000}, {10,1,1000000000}], ML.Types.NumericField );
